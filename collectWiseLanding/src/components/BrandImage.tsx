    ...
    return (
        <div className="relative overflow-hidden bg-gradient-to-b from-white via-blue-50/50 to-white py-12 sm:py-16 md:py-20 lg:py-24">
            <div className="absolute inset-x-0 inset-y-8 overflow-hidden">
                <div className="absolute -left-4 top-1/4 w-48 sm:w-72 h-48 sm:h-72 bg-green-600/10 rounded-full mix-blend-multiply filter blur-lg opacity-50" />
                <div className="absolute right-1/3 top-1/2 w-32 sm:w-48 h-32 sm:h-48 bg-blue-600/10 rounded-full mix-blend-multiply filter blur-lg opacity-40" />
                <div className="absolute -right-4 bottom-1/4 w-48 sm:w-72 h-48 sm:h-72 bg-teal-500/10 rounded-full mix-blend-multiply filter blur-lg opacity-50" />
            </div>
                ...
                <div className="grid lg:grid-cols-2 gap-2 sm:gap-4 lg:gap-12 items-center">
                    ...
                    <div className="lg:pl-12 order-2 text-center lg:text-left">
                        <div className="relative mb-6 order-first">
                            <h2 className="relative text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6 lg:mb-6 mb-8">
                        ...
                        <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-6 leading-relaxed mt-8 lg:mt-0">
