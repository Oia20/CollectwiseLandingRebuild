                ...
                <div className="grid lg:grid-cols-2 gap-2 sm:gap-4 lg:gap-12 items-center">
                    <div className="hidden lg:block relative order-1">
                        ...
                        <div className="relative w-[270px] sm:w-[300px] h-[520px] sm:h-[580px] bg-black rounded-[3rem] shadow-[0_0_0_8px_#1a1a1a,0_8px_20px_-3px_rgba(0,0,0,0.3),0_20px_40px_-12px_rgba(0,0,0,0.5)] transform transition-all duration-700 hover:-translate-y-2 hover:shadow-[0_0_0_8px_#1a1a1a,0_14px_30px_-3px_rgba(0,0,0,0.3),0_30px_60px_-12px_rgba(0,0,0,0.5)]">
                            ...
                            <div className="relative w-full h-full bg-gray-50 rounded-[2.75rem] overflow-hidden shadow-[inset_0_2px_15px_rgba(30,58,138,0.2)]">
                                ...
                                <div className="absolute top-0 inset-x-0 h-6 bg-white flex justify-between items-center px-4 text-xs text-gray-800 z-20">
                                    <span>9:41</span>
                                ...
                                <div className="absolute top-6 w-full bg-gray-50 z-20 px-4 py-2 border-b border-gray-200">
                    ...
                    <div className="lg:pl-12 order-2 text-center lg:text-left">
                        <div className="relative mb-6 order-first">
                            <h2 className={`relative text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6 lg:mb-6 mb-8 transition-all duration-700 transform`}>
                                <span className="relative inline-block">
                                    Maintain a

                                </span>
                                <span className={`block transition-all duration-700 delay-200 transform`}>
                        ...
                        <div className="lg:hidden mb-6">
                            <div className="relative order-1 lg:order-2 flex justify-center sm:mb-0">
                                <div className="absolute inset-0">
                                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[300px] bg-gradient-to-b from-blue-600/10 to-teal-500/10 blur-[50px] opacity-30" />
                                </div>

                                <div className="relative w-[270px] sm:w-[300px] h-[520px] sm:h-[580px] bg-black rounded-[3rem] shadow-[0_0_0_8px_#1a1a1a,0_8px_20px_-3px_rgba(0,0,0,0.2)]">
                                    <div className="absolute top-0 inset-x-0 h-6">
                                        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 h-4 w-[100px] bg-black rounded-b-3xl flex items-center justify-center gap-2">
                                            <div className="w-2 h-2 bg-gray-800 rounded-full"></div>
                                            <div className="w-10 h-1.5 bg-gray-800 rounded-full"></div>
                                    ...
                                    <div className="relative w-full h-full bg-gray-50 rounded-[2.75rem] overflow-hidden">
                                        ...
                                        <div className="absolute top-24 bottom-0 left-0 right-0 overflow-y-auto px-2 py-2 space-y-2 bg-gray-50">
                                            <div className="flex items-start gap-1">
                                                <div className="bg-white rounded-2xl rounded-tl-sm px-4 py-2 shadow-sm max-w-[85%]">
                                                    <p className="text-[15px] text-gray-800">After your most recent payment, the remaining balance should be $108.</p>
                                                </div>
                                    ...
                                    <div className="absolute -bottom-0.5 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gray-800 rounded-full"></div>
                                </div>
                            </div>
                        </div>
                        
                        <p className={`text-base sm:text-lg md:text-xl text-gray-600 mb-6 leading-relaxed mt-8 lg:mt-0 transition-all duration-700 delay-400 transform`}>
                        ...
                        <p className={`text-base sm:text-lg md:text-xl text-gray-600 mb-8 leading-relaxed transition-all duration-700 delay-500 transform`}>
                        ...
                        <div className={`flex flex-wrap gap-4 justify-center lg:justify-start transition-all duration-700 delay-600 transform`}>
